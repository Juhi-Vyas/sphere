              ...
              >
                ...
                <PanelGroup direction="vertical">
                  ...
                  >
                    ...
                    <div className="h-full bg-[#FFF7ED] pt-2 px-1 pb-1">
          ...
          >
            ...
            <div className="h-full bg-[#FFF7ED] pl-2">
              ...
              {isInitializingCall ? (
                ...
                <div className="h-full bg-white border border-orange-100 rounded-[28px] p-1 shadow-sm">

                  <div className="stream-wrapper h-full w-full rounded-[22px] overflow-hidden bg-[#0F172A]">
